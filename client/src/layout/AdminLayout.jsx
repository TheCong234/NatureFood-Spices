...
import { Collapse, Container, InputAdornment, InputBase, Stack } from '@mui/material';
...
// import { Container, fontSize, fontStyle, Stack } from '@mui/system'; Đưng có import từ system
...
export default function AdminLayout() {
  ...
  return (
    <Box>
          ...
          <div style={{ position: 'relative', marginRight: 16, marginLeft: '65px',}}>
            ...
            startAdornment={
                <InputAdornment position="start">
                  <SearchIcon sx={{fontSize:"30px", paddingLeft:'10px', opacity:'0.6'}} />
                </InputAdornment>
              }
              placeholder="Search…"
              style={{
      ...
      {/* Main */}
      <Container sx={{display: 'flex', marginLeft:'-15px'}}> 
      <Drawer variant="permanent" open={open} >
          ...
          <ListItem  disablePadding>
            ...
            <ListItem onClick={() => handleClick('products')}>
              ...
              <ListItemText primary={open.products ? "Sản phẩm" : "Sản phẩm"} />
            ...
            <ListItem onClick={() => handleClick('events')}>
              ...
              <ListItemText primary={open.events ? "Sự kiện" : "Sự kiện"} />
            ...
            <ListItem onClick={() => handleClick('email')}>
              ...
              <ListItemText primary={open.email ? "Email" : "Email"} />
            ...
            <ListItem onClick={() => handleClick('documents')}>
              ...
              <ListItemText primary={open.documents ? "Blog" : "Tài liệu"} />
