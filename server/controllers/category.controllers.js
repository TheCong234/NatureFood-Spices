...
const CategoryController = {
    async getAllCategory(req, res){
        try {
            ...
            return res.status(statusCode.OK).json(BaseResponse.success('Lấy danh sách danh mục thành công', categories));
    ...
    async updateCategory(req, res){
        try {
            ...
            if(updatedCategory){
                ...
                return res.status(statusCode.NO_CONTENT).json(BaseResponse.success('Tạo mới danh mục thất bại vui lòng thử lại', null));
            }
        } catch (error) {
