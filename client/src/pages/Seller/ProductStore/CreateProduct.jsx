  ...
  return (
    <Box sx={{ px: "24px", pb: "24px" }}>
      ...
      <Typography component="p" sx={{ fontStyle: "italic", pt: 2 }}>
        Điền đầy đủ thông tin của sản phẩm vào form để thêm sản phẩm vào cửa
        hàng của bạn
      </Typography>
      ...
      >
        <Box className="flex">
          ...
          <Item elevation={2} className="w-1/3 " sx={{ position: "relative" }}>
            <Typography
              component="h1"
              variant="h6"
              className="text-black font-bold py-2"
            ...
            <FormControl className="w-full" sx={{ mt: 4 }}>
              ...
              >
                {tagData.map((tag, index) => (
                  <MenuItem key={`tag-${index}`} value={tag._id.toString()}>
                    <Checkbox
                      checked={tagsSelected.indexOf(tag._id.toString()) > -1}
                    />
